...
class KanbanApp(App):
    ...
    BINDINGS = [
        ...
        Binding("1", "jump_to_1", "Jump 1"),
        Binding("2", "jump_to_2", "Jump 2"),
        Binding("3", "jump_to_3", "Jump 3"),
        Binding("4", "jump_to_4", "Jump 4"),
        Binding("5", "jump_to_5", "Jump 5"),
        Binding("6", "jump_to_6", "Jump 6"),
        Binding("7", "jump_to_7", "Jump 7"),
        Binding("8", "jump_to_8", "Jump 8"),
        Binding("9", "jump_to_9", "Jump 9"),
        Binding("g,home", "move_top", "Top"),
        Binding("G,end", "move_bottom", "Bottom"),
        Binding("plus", "next_page", "Next"),
        Binding("minus", "prev_page", "Prev"),
